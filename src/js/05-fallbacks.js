...
function getFallback16(){return {summary:'Build vs buy analysis unavailable -- baseline used.',recommendation:'Needs Review',confidence:0,build_vs_buy_score:null,options:[],key_risks:['Run with API key for live build vs buy analysis'],decision_factors:[],data_sources:['Baseline estimate']};}
function getFallback17(){return {summary:'Source citation audit unavailable -- baseline used.',overall_source_confidence:0,citations:[],unsupported_claims:[],source_gaps:['Run with API key for full citation audit'],data_sources:['Baseline estimate']};}
...
// HEAT MAP RENDERER lives in 06-ui.js.
