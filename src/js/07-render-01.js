...
Return ONLY this JSON:
{
  ...
  const _rdCtx1 = typeof buildRealDataCtx === 'function'
    ? buildRealDataCtx(['demographics','business_density','macro','crime','health','acs_expanded','rural_urban','cbp_county','food_access','local_unemp','crime_city','schools','acs_home_value','cdc_svi','hud_income','acs_industry_mix','building_permits'])
    : '';
