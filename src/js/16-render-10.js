async function runAgent10(a3,a4,a5,a7,a9) {
  ...
  // (Old single-call template removed — sub-calls handle prompt generation)
  /* REMOVED: old single-call template (see 25-agent-10-parts.js for active prompts)
  "phases_PLACEHOLDER": [
    {
